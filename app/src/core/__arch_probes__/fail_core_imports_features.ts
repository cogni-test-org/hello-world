...
/**
 * Module: `@core/__arch_probes__/fail_core_imports_features`
 * Purpose: Architecture probe demonstrating invalid core→features import (must fail dependency-cruiser).

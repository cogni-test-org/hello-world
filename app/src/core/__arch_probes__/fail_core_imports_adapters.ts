...
/**
 * Module: `@core/__arch_probes__/fail_core_imports_adapters`
 * Purpose: Architecture probe demonstrating invalid core→adapters import (must fail dependency-cruiser).

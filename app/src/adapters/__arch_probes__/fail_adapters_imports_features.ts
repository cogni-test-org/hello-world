...
/**
 * Module: `@adapters/__arch_probes__/fail_adapters_imports_features`
 * Purpose: Architecture probe demonstrating invalid adapters→features import (must fail dependency-cruiser).

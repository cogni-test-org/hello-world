...
/**
 * Module: `@adapters/__arch_probes__/fail_adapters_imports_components`
 * Purpose: Architecture probe demonstrating invalid adapters→components import (must fail dependency-cruiser).

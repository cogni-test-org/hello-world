...
/**
 * Module: `@adapters/__arch_probes__/fail_adapters_imports_bootstrap`
 * Purpose: Architecture probe demonstrating invalid adapters→bootstrap import (must fail dependency-cruiser).
...
export const probeFail = resolveAiDeps;

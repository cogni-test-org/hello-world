...
/**
 * Module: `@bootstrap/__arch_probes__/pass_bootstrap_imports_shared`
 * Purpose: Architecture probe demonstrating valid bootstrap→shared import (should pass dependency-cruiser).
 * Scope: Tests allowed import from bootstrap to shared layer. Does NOT test forbidden imports.

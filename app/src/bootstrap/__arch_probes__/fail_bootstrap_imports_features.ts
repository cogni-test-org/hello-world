...
/**
 * Module: `@bootstrap/__arch_probes__/fail_bootstrap_imports_features`
 * Purpose: Architecture probe demonstrating invalid bootstrap→features import (must fail dependency-cruiser).

...
/**
 * Module: `@contracts/__arch_probes__/fail_contracts_imports_adapters`
 * Purpose: Architecture probe demonstrating invalid contracts→adapters import (must fail dependency-cruiser).

...
/**
 * Module: `@contracts/__arch_probes__/fail_contracts_imports_ports`
 * Purpose: Architecture probe demonstrating invalid contracts→ports import (must fail dependency-cruiser).

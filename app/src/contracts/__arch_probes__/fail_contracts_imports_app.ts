...
/**
 * Module: `@contracts/__arch_probes__/fail_contracts_imports_app`
 * Purpose: Architecture probe demonstrating invalid contracts→app import (must fail dependency-cruiser).

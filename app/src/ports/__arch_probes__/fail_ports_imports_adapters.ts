...
/**
 * Module: `@ports/__arch_probes__/fail_ports_imports_adapters`
 * Purpose: Architecture probe demonstrating invalid ports→adapters import (must fail dependency-cruiser).

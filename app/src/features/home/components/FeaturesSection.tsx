 ...
 * Purpose: Homepage features showcase section with three feature cards.
 * Scope: Feature component that provides feature data to kit components. Does not handle styling.
 * Invariants: Uses kit components only; provides content and data only.
 * Side-effects: none
 * Notes: Uses FeaturesGrid kit component with homepage-specific feature data.
 * Links: src/components/kit/sections/FeaturesGrid.tsx
 * @public
 */
...
import { FeaturesGrid } from "@/components/kit/sections";
...
export function FeaturesSection(): ReactElement {
  return <FeaturesGrid features={features} surface="default" />;
}

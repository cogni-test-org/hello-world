...
/**
 * Module: `@features/__arch_probes__/fail_features_imports_bootstrap`
 * Purpose: Architecture probe demonstrating invalid features→bootstrap import (must fail dependency-cruiser).
...
import { container } from "@/bootstrap/__arch_probes__/container";
export const probeFail = container;

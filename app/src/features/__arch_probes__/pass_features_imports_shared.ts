...
/**
 * Module: `@features/__arch_probes__/pass_features_imports_shared`
 * Purpose: Architecture probe demonstrating valid features→shared import (must pass dependency-cruiser).

...
/**
 * Module: `@features/__arch_probes__/fail_features_imports_adapters`
 * Purpose: Architecture probe demonstrating invalid features→adapters import (must fail dependency-cruiser).
...
import { litellm } from "@/adapters/__arch_probes__/litellm";
export const probeFail = litellm;
